						...
						>
							...
							>
								...
								<div className="absolute inset-0 flex items-center justify-center">
									<div className="w-72 h-72 rounded-full border-[12px] border-primary/5 animate-pulse" />
								</div>

								{/* Book 3D Stack */}
								<div className="relative" style={{ perspective: "800px" }}>
									{/* Shadow pages beneath */}
									<div className="absolute top-4 left-4 w-64 h-80 sm:w-72 sm:h-96 bg-gray-200 rounded-xl opacity-60 rotate-3" />
									<div className="absolute top-2 left-2 w-64 h-80 sm:w-72 sm:h-96 bg-gray-100 rounded-xl opacity-80 rotate-1" />

									{/* Main Cover */}
									<motion.div
										animate={{ y: [0, -10, 0] }}
										transition={{ duration: 4, repeat: Infinity, ease: "easeInOut" }}
										className="relative w-64 h-80 sm:w-72 sm:h-96 rounded-xl overflow-hidden shadow-2xl border border-gray-200"
									>
										{/* Cover Design matching the PDF cover */}
										<div className="absolute inset-0 bg-white">
											{/* Top section — white background with KENYA letters */}
											<div className="h-[55%] bg-white flex items-center justify-center relative overflow-hidden border-b-[8px] border-primary">
												<div className="absolute top-3 left-3 text-xs font-black text-primary border border-primary px-2 py-0.5">
													IMPERIA<br/>
													<span className="text-[8px] font-light">CONSULTING</span>
												</div>
												<p className="text-5xl sm:text-6xl font-black text-gray-100 tracking-widest select-none">KENYA</p>
											</div>
											{/* Dark bottom */}
											<div className="h-[45%] bg-white flex flex-col justify-end p-4">
												<p className="text-primary font-black text-base leading-tight">RELOCATION<br/>GUIDE TO KENYA</p>
												<p className="text-gray-500 text-[10px] mt-1 font-semibold">A Step-by-Step Guide for Diplomats and Expats</p>
											</div>
										</div>
									</motion.div>
									...
									<motion.div
										...
										className="absolute -top-4 -right-4 bg-primary text-white text-xs font-black px-3 py-2 rounded-xl shadow-lg"
									>
										FREE
									</motion.div>
									<motion.div
										...
										className="absolute -bottom-4 -left-4 bg-white text-primary border border-primary/20 text-xs font-black px-3 py-2 rounded-xl shadow-lg flex items-center gap-1"
									>
										<Icon icon="mdi:star" />
